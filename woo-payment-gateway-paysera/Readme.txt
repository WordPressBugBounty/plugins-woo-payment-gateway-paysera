...
* Update - Updated PHP version to 7.4
* Fix - Fixed security vulnerabilities for plugin
* Fix - Fixed Paysera delivery terminal selections getting cleared on checkout page due to refresh
...
= 3.2.7 =
WordPress tested upto 6.2, fixed checkout page default country selection logic, fixed Paysera delivery gateways displayed if plugin is not active or gateway is disabled, Project ID negative value prevention, Invalid project credential validation on delivery settings.
